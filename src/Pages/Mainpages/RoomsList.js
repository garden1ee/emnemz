...
const Roomslist = () => {
    ...
    async function addroom() {
      const users = ["bFloGsWXQ5ZNyb2acYagjgcl63z2", "kj2ctq3RAoYuKdO2bLrQIFeEmGu1"]

    
     
      const info =  {title: "포켓몬스터",
  ...
  authorwords:"피카츄 파이리 꼬부기 이야기 "};
      ...
      const characters = [{name:"피카츄",pic:"https://w.namu.la/s/51f656cb58ffc529724fc1f62dc055430f035f937344cda61f6abcfa0e5001e2bc0cd13ae4a192b30962943a5526da6554ae6445388ced9d468e24369ed4b1f7afa84b060f048f8dec8b7d2967a0b280835f589cfaf5f81bf5679a19944fec600bbe8691592be51d35cd59640a120319",
  },
      ...
      await firestore.doc('rooms/6').set({
        info,
        characters,
        completed: false,
        agree_num: 0,
